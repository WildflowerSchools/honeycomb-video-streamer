...
class HoneycombClient(object):
    ...
    def get_assignments(self, environment_id):
        ...
        for assignment in assignments:
            if assignment["assigned_type"] == "DEVICE" and assignment["assigned"]["device_type"] in ["PI3WITHCAMERA", "PI4WITHCAMERA"]:
                camera_details = (assignment["assignment_id"], assignment["assigned"]["device_id"], assignment["assigned"]["name"])
